 ...
 */
public class SubstructureEdit {

    int[] originalPairedSites;
    int[] pairedSites;

    public SubstructureEdit(int[] pairedSites) {
    ...
    public static void main(String[] args) {
        String dbs = ".......((((((((.(....)))).(((((.............)))))..)))))....";
        SubstructureEdit edit = new SubstructureEdit(RNAFoldingTools.getPairedSitesFromDotBracketString(dbs));
